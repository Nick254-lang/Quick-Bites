...
- [x] server.js (replaced by Next.js API routes)
- [x] client/pages/*.html (replaced by app/*.js pages)
- [x] client/js/*.js (refactored to React components)
- [x] config/firebaseAdmin.js (moved to lib/firebaseAdmin.js)

## Keep
- [x] config/serviceAccountKey.json (needed for server API routes)
